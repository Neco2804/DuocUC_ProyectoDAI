...
<head>
  ...
  <?php include('css/user_main_css.php') ?>
  <?php include('css/one-page-wonder_css.php') ?>
...
<div class="row">
		<div class="col-md-6">
			...
			<p>
            <center> Ingresa acá para buscar un profesional cercano a ti, y establece una visita </center>
			</p>
            </form>
		</div>
		<div class="col-md-6">
			...
			<p>
               <center> Ve el historial de visitas que haz solicitado acá</center>
    		</p>
            </form>
		</div>
	</div>
